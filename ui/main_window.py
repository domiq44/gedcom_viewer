...
class GedcomViewer:
    ...
    def __init__(self, root):
        ...
        self.detail_panel.highlighter = self.highlighter
    ...
    def _build_detail_views(self):
        # Les résolveurs délèguent via self.controller (et non une méthode liée)
        # car self.controller est remplacé après un chargement asynchrone de fichier.
        view_specs = [
            (
                "individual",
                "INDI",
                ...
                True,
                {
                    ...
                    "set_object_resolver": lambda ptr: self.controller.get_object(ptr),
                    "set_object_display_name_resolver": lambda entity, entity_type=None: self.controller.format_entity_display_name(
                        entity, entity_type
                    ),
                },
            ),
            ...
            (
                ...
                NoteView,
                True,
                {"set_reference_resolver": lambda ptr: self.controller.get_source(ptr)},
            ),
